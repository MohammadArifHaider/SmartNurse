            ...
            <li class="nav-item">
              ...
              <div  class="collapse" id="patient-{{$patient->id}}">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li ><button onclick="change_address()" type="button" class="btn btn-sm btn-primary" style="font-size:10px">Change Address</button> <span><button onclick="add_note()" type="button" class="btn btn-sm btn-primary" style="font-size:10px">Note</button></span></li>
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
 ...
 <script src="{{asset('assets')}}/vendors/datatables/dataTables.bootstrap.min.js"></script>
  ...
  <script src="{{asset('assets')}}/js/custom/custom_full_calendar.js?{{time()}}"> </script>
